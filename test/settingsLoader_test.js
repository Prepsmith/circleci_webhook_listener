...
describe('Settings', function(){
    it('can load settings', function(done) {
        settingsLoader.load(path.join('test','settings','correct.json'),function(err,res){
            if (err){ throw err}
            assert(res.port);
    ...
    it('will default to default port', function(done) {
        settingsLoader.load(path.join('test','settings','noPort.json'),function(err,res){
            assert(!err,err)
    ...
    it('will default to default download path', function(done) {
        settingsLoader.load(path.join('test','settings','noPath.json'),function(err,res){
            assert(!err,err)
    ...
    it('won\'t accept empty settings', function(done) {
        settingsLoader.load(path.join('test','settings','empty.json'),function(err,res){
    ...
    it('won\'t accept missing or empty token', function(done) {
        settingsLoader.load(path.join('test','settings','noToken.json'),function(err,res){
    ...
    it('won\'t accept missing or empty url', function(done) {
        settingsLoader.load(path.join('test','settings','noUrl.json'),function(err,res){
